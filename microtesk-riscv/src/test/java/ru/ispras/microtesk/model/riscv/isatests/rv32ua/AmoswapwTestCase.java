...
package ru.ispras.microtesk.model.riscv.isatests.rv32ua;
...
public class AmoswapwTestCase extends RiscVTest {
  @Test
  public void test() {
    setCommandLineOption(Option.VERBOSE);

    final Statistics statistics = run("isa_tests/rv32ua/amoswap_w.rb");
