...
package ru.ispras.microtesk.model.riscv.isatests.rv32uc;
...
public class RvcTestCase extends RiscVTest {
  @Test
  public void test() {
    setCommandLineOption(Option.VERBOSE);

    final Statistics statistics = run("isa_tests/rv32uc/rvc.rb");
