...
import ru.ispras.testbase.knowledge.branch.beqz.BeqzThenElseGenerator;
import ru.ispras.testbase.knowledge.integer.IntNumber;
import ru.ispras.testbase.knowledge.iterator.Iterator;

/**
 * {@link RiscvEqzDataGenerator} is a test data generator for BEQZ instructions.
 *
 * @author <a href="mailto:kamkin@ispras.ru">Alexander Kamkin</a>
 */
public final class RiscvEqzDataGenerator extends RiscvBranchDataGenerator {
  @Override
