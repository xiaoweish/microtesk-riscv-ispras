...
class ErrataMicrochipFmax < RiscVBaseTemplate
    @rand_int = nil
    @rand_float = nil
    ...
    def run
        ...
        fmax_s f_reg_dst, f_reg_src1, f_reg_src2
        Or gp_reg_dst, t1, gp_reg_src2  
        ...
        fmax_s f_reg_dst, f_reg_src1, f_reg_src2
        ori gp_reg_dst, t1, self.rand_int(1,64)
        ...
        fmax_s f_reg_dst, f_reg_src1, f_reg_src2
        Or gp_reg_dst, t1, gp_reg_src2
        beq gp_reg_dst, t1, :next4
        beq gp_reg_dst, gp_reg_src2, :next4
        bneq gp_reg_dst, t1, :next4
        ...
        fmax_s f_reg_dst, f_reg_src1, f_reg_src2
        add gp_reg_dst, t1, gp_reg_src2
        beq gp_reg_dst, t1, :next7
        beq gp_reg_dst, gp_reg_src2, :next7
        bneq gp_reg_dst, t1, :next7
