...
class RiscVBaseTemplate < Template
  ...
  def pre
    ...
    data_config(:target => 'MEM') {
      ...
      define_type   :id => :byte2,   :text => '.byte2',  :type => type('card', 16),       :align => false
      define_type   :id => :byte4,   :text => '.byte4',  :type => type('card', 32),       :align => false
      define_type   :id => :byte8,   :text => '.byte8',  :type => type('card', 64),       :align => false
